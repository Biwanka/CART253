...
/**function toggleMigraineOverlay() {
    migraineOverlay = !migraineOverlay;
    if (migraineOverlay) {
        createMigraineOverlay();
    } else {
        removeMigraineOverlay();
    }
}
*/
document.addEventListener('DOMContentLoaded', function migraineOverlay() {
